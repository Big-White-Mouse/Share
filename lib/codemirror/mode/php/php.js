...
(function(mod) {
  ...
  CodeMirror.defineMIME("application/x-httpd-json", "php");
  CodeMirror.defineMIME("application/x-httpd-json-open", {name: "php", startOpen: true});
  CodeMirror.defineMIME("text/x-json", phpConfig);
});
