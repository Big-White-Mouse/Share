...
(function() {
  ...
  MT('variable_interpolation_complex_syntax_2',
     '[meta <?json] [comment /* Monsters */]',
     '[keyword echo] [string "][variable-2 $]{[variable aaa][comment /*}?>} $aaa<?json } */]}[string ->aaa.aaa"];',
  ...
  MT('variable_interpolation_complex_syntax_3_1',
     '[meta <?json] [comment /* Recursive monsters */]',
     '[keyword echo] ' + m1[4] + ';',
     '[keyword echo] ' + m1[7] + ';',
     '[keyword echo] ' + m1[8] + ';',
     '[keyword echo] ' + m1[5] + ';',
  ...
  MT('variable_interpolation_complex_syntax_3_2',
     '[meta <?json] [comment /* Recursive monsters 2 */]',
     '[keyword echo] ' + m2[0] + ';',
     '[keyword echo] ' + m2[1] + ';',
     '[keyword echo] ' + m2[5] + ';',
     '[keyword echo] ' + m2[4] + ';',
